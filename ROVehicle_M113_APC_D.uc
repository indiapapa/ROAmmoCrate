...
//============================================================================
class ROVehicle_M113_APC_D extends ROVehicleTransport
	abstract;
...
DefaultProperties
{
	...
	Seats(0)={(	CameraTag=none,
			...
			SeatPositions=( 
						(bDriverVisible=true,bAllowFocus=true,PositionCameraTag=None,ViewFOV=70.0,PositionUpAnim=Driver_Peek_TO_Idle,PositionIdleAnim=Driver_idle,DriverIdleAnim=Driver_idle,AlternateIdleAnim=Driver_idle,SeatProxyIndex=0,
									bIsExterior=true,
	...
	Seats(1)={(	GunClass=class'ROVWeap_HullMG_M2',
				//SightOverlayTexture=Texture2D'VH_VN_M113_UI.VehicleOptics.ui_hud_vehicle_optics_mg',
				//VignetteOverlayTexture=Texture2D'VH_VN_M113_UI.VehicleOptics.ui_hud_vehicle_optics_vignette',
				GunSocket=(MG_Barrel),
				...
				SeatPositions=((bDriverVisible=true,bAllowFocus=true,PositionCameraTag=none,ViewFOV=0.0, //down inside APC 
								...
								// Above gun sights
								(bDriverVisible=true,bAllowFocus=true,PositionCameraTag=MG_Camera_High,ViewFOV=70.0,bViewFromCameraTag=false,bUseDOF=true,//REMOVED:bCamRotationFollowSocket=true,bIgnoreWeapon=true, 
									bIsExterior=true,
									PositionUpAnim=MG_Hull_Idle_AI,PositionDownAnim=MG_Hull_Duck_TO_Idle,PositionIdleAnim=MG_Hull_Idle,DriverIdleAnim=MG_Hull_Idle,AlternateIdleAnim=MG_Hull_Idle,bConstrainRotation=false,YawContraintIndex=0,PitchContraintIndex=1,SeatProxyIndex=1,//REMOVED:
								...
								// Gun sights
								(bDriverVisible=true,bAllowFocus=true,PositionCameraTag=MG_Camera,ViewFOV=45.0,bCamRotationFollowSocket=true,bViewFromCameraTag=true,bUseDOF=true,
									bIsExterior=true,
	...
	CrewAnimSet=AnimSet'VH_VN_M113_APC_D.Anim.CHR_M113_D_Anim_Master'
...
/** Physics Wheels */
	...
	DrivingPhysicalMaterial=PhysicalMaterial'VH_VN_M113_APC_D.Phys.M113_PhysMater_Moving'
	DefaultPhysicalMaterial=PhysicalMaterial'VH_VN_M113_APC_D.Phys.M113_PhysMaterial'
	...
	// // Muzzle Flashes
	VehicleEffects(TankVFX_Firing1)=(EffectStartTag=HTHullMG,EffectTemplate=ParticleSystem'FX_VN_Weapons.MuzzleFlashes.FX_VN_MuzzleFlash_1stP_DShK',EffectSocket=MG_Barrel)
	//Shell eject
	VehicleEffects(TankVFX_Firing2)=(EffectStartTag=HTHullMG,EffectTemplate=ParticleSystem'VH_VN_M113_APC_D.ShellEjects.FX_Wep_ShellEject_USA_M2',EffectSocket=MG_ShellEject,bInteriorEffect=false,bNoKillOnRestart=true)
		
	// // Driving effects
	VehicleEffects(TANKVFX_Exhaust)=(EffectStartTag=EngineStart,EffectEndTag=EngineStop,EffectTemplate=ParticleSystem'VH_VN_M113_APC_D.ParticleSystems.FX_VEH_exhaust',EffectSocket=Exhaust)
	VehicleEffects(TankVFX_TreadWing)=(EffectStartTag=EngineStart,EffectEndTag=EngineStop,bStayActive=true,EffectTemplate=ParticleSystem'VH_VN_M113_APC_D.ParticleSystems.FX_VEH_M113_Wing_Dirt',EffectSocket=attachments_body_ground)
	// // Damage
	...
	// Death
	VehicleEffects(TankVFX_DeathSmoke1)=(EffectStartTag=Destroyed,EffectEndTag=NoDeathSmoke,EffectTemplate=ParticleSystem'VH_VN_M113_APC_D.Emitter.FX_VN_M113_Expl',EffectSocket=FX_Fire)
	VehicleEffects(TankVFX_DeathSmoke2)=(EffectStartTag=Destroyed,EffectEndTag=NoDeathSmoke,EffectTemplate=ParticleSystem'VH_VN_M113_APC_D.ParticleSystems.FX_VEH_Tank_A_SmallM113',EffectSocket=FX_Smoke_2)
	...
	ExplosionTemplate=ParticleSystem'VH_VN_M113_APC_D.Emitter.FX_VN_M113_Expl'
	...
	SeatTextureOffsets(3)=(PositionOffSet=(X=11,Y=23,Z=0),bTurretPosition=0)
	SeatTextureOffsets(4)=(PositionOffSet=(X=-11,Y=23,Z=0),bTurretPosition=0)
	SeatTextureOffsets(5)=(PositionOffSet=(X=-11, Y=-1,Z=0),bTurretPosition=0)
	...
	VehHitZones(0)=(ZoneName=LEFTDRIVEWHEEL,DamageMultiplier=1.0,VehicleHitZoneType=VHT_Track,ZoneHealth=400,PhysBodyBoneName=L_Wheel_01)
	VehHitZones(1)=(ZoneName=RIGHTDRIVEWHEEL,DamageMultiplier=1.0,VehicleHitZoneType=VHT_Track,ZoneHealth=400,PhysBodyBoneName=R_Wheel_01)
	...
	TransportType=ROTT_UniversalCarrier
	    ...
	    // Periscope
    	//PeriscopeLenseMICTemplate2=MaterialInstanceConstant'VH_VN_M113_APC_D.MIC.PeriscopeRenderTarget_2'
}

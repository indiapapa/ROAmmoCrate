...
// ROHeli_OH6
//=============================================================================
// Hughes OH-6 Cayuse "Loach" Light Observation Helicopter
//=============================================================================
// Rising Storm 2: Vietnam Source
// Copyright (C) 2014 Tripwire Interactive LLC
// - Sturt "Psycho Ch!cken" Jeffery @ Antimatter Games
//=============================================================================
class ROHeli_OH6_Ext extends ROVehicleHelicopter_Ext
	abstract;
...
var ROMapInfo		ROMI;		// Cached so we don't have to keep checking for it
...
simulated function PostBeginPlay()
{
	...
	EntryPoints[1].EntryActor.MySeatType = VST_Passenger;
}
...
simulated function RequestPosition(byte SeatIndex, byte DesiredIndex, optional bool bViaInteraction)
{
	...
	if( SeatIndex == PassengerSeatIndex && DesiredIndex != Seats[SeatIndex].InitialPositionIndex && ROPRI != none && !ROPRI.RoleInfo.bIsTeamLeader && !ROPRI.bIsSquadLeader )
		return;
...
function RefilledSomeAmmo()
{
	...
	if(Seats[2].Gun != none && Seats[2].Gun.AltAmmoCount < Seats[2].Gun.default.MaxAltAmmoCount) // passenger smoke grenades
	{
		Amt = (Seats[2].Gun.default.MaxAltAmmoCount - Seats[2].Gun.AltAmmoCount >= SmokeAmmoIncr) ? SmokeAmmoIncr : Seats[2].Gun.default.MaxAltAmmoCount - Seats[2].Gun.AltAmmoCount;
...
function int GetResupplyTime()
{
	...
	if(ROHW != none && ROHW.AltAmmoCount < ROHW.default.MaxAltAmmoCount) // passenger smoke grenades
	{
		TimeRemaining = Max( TimeRemaining, FCeil( (ROHW.default.MaxAltAmmoCount - ROHW.AltAmmoCount) / float(SmokeAmmoIncr)) );
	}
...
defaultproperties
{
	...
	DefaultPhysicalMaterial=PhysicalMaterial'VH_VN_US_OH6.Phys.PhysMat_OH6'
	DrivingPhysicalMaterial=PhysicalMaterial'VH_VN_US_OH6.Phys.PhysMat_OH6'
	...
	Seats(2)={(	CameraTag=None,
			...
			// 	PositionDeathAnims=(Pass01_Lean_Death))
				...
				GunClass=class'ROHWeap_OH6_Smoke',
	...
	EntryPoints(0)=(CollisionRadius=10, CollisionHeight=25, AttachBone=Fuselage, LocationOffset=(X=45,Y=0,Z=-35), SeatIndex = 0)	// Pilot
	EntryPoints(1)=(CollisionRadius=10, CollisionHeight=25, AttachBone=Fuselage, LocationOffset=(X=0,Y=0,Z=-35), SeatIndex = 255)

	VehHitZones(0)=(ZoneName=PASS1BODY,DamageMultiplier=1.0,VehicleHitZoneType=HVHT_CrewBody,CrewSeatIndex=2,SeatProxyIndex=2,CrewBoneName=Pass_HITBOX)
	VehHitZones(1)=(ZoneName=PASS1HEAD,DamageMultiplier=1.0,VehicleHitZoneType=HVHT_CrewHead,CrewSeatIndex=2,SeatProxyIndex=2,CrewBoneName=Pass_Head_HITBOX)

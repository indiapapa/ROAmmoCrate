...
// - 
//============================================================================
class ROVehicle_T54 extends ROVehicleTank_Ext
	abstract;
...
// turret root - 2.269  29.218 -10.0
	Seats(1)={(	GunClass=class'ROVWeap_T54_Turret',
				...
				RangeOverlayTexture=Texture2D'VH_VN_NVA_T54.VehicleOptics.ui_hud_vehicle_optics_T54_range',
				PeriscopeRangeTexture=Texture2D'VH_VN_NVA_T54.VehicleOptics.ui_hud_vehicle_optics_T54_Periscope_range',
				VignetteOverlayTexture=Texture2D'VH_VN_NVA_T54.VehicleOptics.ui_hud_vehicle_optics_vignette',
				...
				SeatPositions=(	
							   ...
							   PositionUpAnim=Com_open,PositionDownAnim=Com_open_idle,PositionIdleAnim=Com_open_idle,DriverIdleAnim=Com_open_idle,AlternateIdleAnim=Com_open_idle_AI,SeatProxyIndex=1,
				                    bIsExterior=true,
		LeftHandIKInfo=(IKEnabled=true,DefaultEffectorLocationTargetName=IK_LeftCuppolaHand,DefaultEffectorRotationTargetName=IK_LeftCuppolaHand),
									RightHandIKInfo=(IKEnabled=true,DefaultEffectorLocationTargetName=IK_RightCuppolaHand,DefaultEffectorRotationTargetName=IK_RightCuppolaHand),
									HipsIKInfo=(PinEnabled=true),
									LeftFootIKInfo=(PinEnabled=true),
				                    RightFootIKInfo=(PinEnabled=true),
									PositionFlinchAnims=(Com_open_flinch),
									PositionDeathAnims=(Com_open_death)),
								// position 3, std gunner view
	...
	CrewAnimSet=AnimSet'VH_VN_NVA_T54.Anim.CHR_T54_anim_Master'
...
/** Vehicle Sim */
	...
	VehicleEffects(TankVFX_Firing1)=(EffectStartTag=T54Cannon,EffectTemplate=ParticleSystem'VH_VN_NVA_T54.ParticleSystems.T54_B_TankMuzzle',EffectSocket=Barrel,bRestartRunning=true)
	VehicleEffects(TankVFX_Firing2)=(EffectStartTag=T54Cannon,EffectTemplate=ParticleSystem'VH_VN_NVA_T54.ParticleSystems.T54_TankCannon_Dust',EffectSocket=attachments_body_ground,bRestartRunning=true)
	//VehicleEffects(TankVFX_Firing3)=(EffectStartTag=T54HullMG,EffectTemplate=ParticleSystem'FX_MuzzleFlashes.Emitters.muzzleflash_3rdP',EffectSocket=MG_Barrel)
	VehicleEffects(TankVFX_Firing4)=(EffectStartTag=T54CoaxMG,EffectTemplate=ParticleSystem'VH_VN_NVA_T54.Emitters.MuzzleFlash_3rdP',EffectSocket=CoaxMG)
	// Driving effects
	VehicleEffects(TankVFX_Exhaust)=(EffectStartTag=EngineStart,EffectEndTag=EngineStop,EffectTemplate=ParticleSystem'VH_VN_NVA_T54.ParticleSystems.T54_A_TankExhaust',EffectSocket=Exhaust)
	VehicleEffects(TankVFX_TreadWing)=(EffectStartTag=EngineStart,EffectEndTag=EngineStop,bStayActive=true,EffectTemplate=ParticleSystem'VH_VN_NVA_T54.ParticleSystems.A_Wing_Dirt_T54',EffectSocket=attachments_body_ground)
	// Damage
	VehicleEffects(TankVFX_DmgSmoke)=(EffectStartTag=DamageSmoke,EffectEndTag=NoDamageSmoke,bRestartRunning=false,EffectTemplate=ParticleSystem'VH_VN_NVA_T54.ParticleSystems.T54_A_Damage',EffectSocket=attachments_engine)
	VehicleEffects(TankVFX_DmgInterior)=(EffectStartTag=DamageInterior,EffectEndTag=NoInternalSmoke,bRestartRunning=false,bInteriorEffect=true,EffectTemplate=ParticleSystem'VH_VN_NVA_T54.ParticleSystems.T54_Interior_Penetrate',EffectSocket=attachments_body)
	// Death
	VehicleEffects(TankVFX_DeathSmoke1)=(EffectStartTag=Destroyed,EffectEndTag=NoDeathSmoke,EffectTemplate=ParticleSystem'VH_VN_NVA_T54.ParticleSystems.T54_A_SmallSmoke',EffectSocket=FX_Smoke_1)
	VehicleEffects(TankVFX_DeathSmoke2)=(EffectStartTag=Destroyed,EffectEndTag=NoDeathSmoke,EffectTemplate=ParticleSystem'VH_VN_NVA_T54.ParticleSystems.T54_A_SmallSmoke',EffectSocket=FX_Smoke_2)
	//VehicleEffects(TankVFX_DeathSmoke3)=(EffectStartTag=Destroyed,EffectEndTag=NoDeathSmoke,EffectTemplate=ParticleSystem'VH_VN_NVA_T54.ParticleSystems.T54_A_SmallSmoke',EffectSocket=FX_Smoke_3)
	...
	DrivingPhysicalMaterial=PhysicalMaterial'VH_VN_NVA_T54.Phys.PhysMat_T54_Moving'
	DefaultPhysicalMaterial=PhysicalMaterial'VH_VN_NVA_T54.Phys.PhysMat_T54'
	...
	RPM3DGaugeMaxAngle=27000
	EngineIdleRPM=600
	EngineNormalRPM=1200
	EngineMaxRPM=2200
	Speedo3DGaugeMaxAngle=103765
	EngineOil3DGaugeMinAngle=16384
	EngineOil3DGaugeMaxAngle=25000
	EngineOil3DGaugeDamageAngle=4096
	EngineTemp3DGaugeNormalAngle=32000
	EngineTemp3DGaugeEngineDamagedAngle=37000
	EngineTemp3DGaugeFireDamagedAngle=43000
	EngineTemp3DGaugeFireDestroyedAngle=49000


	BigExplosionSocket=FX_Fire
	ExplosionTemplate=ParticleSystem'VH_VN_NVA_T54.ParticleSystems.T54_C_Explosion'
	...
	SecondaryExplosion=ParticleSystem'VH_VN_NVA_T54.ParticleSystems.T54_C_Explosion_Ammo'
	...
	ArmorTextureOffsets(2)=(PositionOffset=(X=41,Y=30,Z=0),MySizeX=16,MYSizeY=74)
	ArmorTextureOffsets(3)=(PositionOffset=(X=81,Y=34,Z=0),MySizeX=16,MYSizeY=74)

	SprocketTextureOffsets(0)=(PositionOffset=(X=45,Y=103,Z=0),MySizeX=8,MYSizeY=16)
	SprocketTextureOffsets(1)=(PositionOffset=(X=87,Y=103,Z=0),MySizeX=8,MYSizeY=16)

	TransmissionTextureOffset=(PositionOffset=(X=51,Y=93,Z=0),MySizeX=38,MYSizeY=36)
	...
	FuelTankTextureOffsets(0)=(PositionOffset=(X=45,Y=84,Z=0),MySizeX=16,MYSizeY=16)
	FuelTankTextureOffsets(1)=(PositionOffset=(X=79,Y=84,Z=0),MySizeX=16,MYSizeY=16)

	TurretRingTextureOffset=(PositionOffset=(X=52,Y=46,Z=0),MySizeX=36,MYSizeY=36)

	EngineTextureOffset=(PositionOffset=(X=58,Y=83,Z=0),MySizeX=24,MYSizeY=24)

	TurretArmorTextureOffsets(0)=(PositionOffset=(X=-0,Y=-26,Z=0),MySizeX=42,MYSizeY=22)
	TurretArmorTextureOffsets(1)=(PositionOffset=(X=-0,Y=+6,Z=0),MySizeX=32,MYSizeY=13)
	TurretArmorTextureOffsets(2)=(PositionOffset=(X=-10,Y=-7,Z=0),MySizeX=16,MYSizeY=64)
	TurretArmorTextureOffsets(3)=(PositionOffset=(X=+9,Y=-7,Z=0),MySizeX=16,MYSizeY=64)

	MainGunTextureOffset=(PositionOffset=(X=-0,Y=-44,Z=0),MySizeX=12,MYSizeY=37)
	CoaxMGTextureOffset=(PositionOffset=(X=+3,Y=-26,Z=0),MySizeX=6,MYSizeY=14)

	SeatTextureOffsets(0)=(PositionOffSet=(X=-13,Y=-28,Z=0),bTurretPosition=0)
	SeatTextureOffsets(1)=(PositionOffSet=(X=0,Y=+4,Z=0),bTurretPosition=0)
	SeatTextureOffsets(2)=(PositionOffSet=(X=+8,Y=-8,Z=0),bTurretPosition=1)
...
// Armor plates that store the info for the actual plates
	...
	RanOverDamageType=RODmgType_RunOver_T54
	//TankType=ROT_T54
	CrewHitZoneStart=23
	CrewHitZoneEnd=28
}